...
ScrollTrigger.create({ trigger: ".about", start: "top top", onEnter() { scene.background.copy(blackColor); bgMaterial.opacity = 0; setPixelTransition(0, "#000000"); setStickerOpacity("hero", 0); if (cursor3d && scenePhase === 0) cursor3d.visible = false; }, onLeaveBack() { setPixelTransition(1, "#000000"); } });
